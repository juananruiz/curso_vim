...
" Quieres Vim, no vi. Cuando Vim encuentra un fichero .vimrc se pone por defecto en modo 'nocompatible'
" En cualquier caso así queda claro cuales son tus intenciones ;-)
set nocompatible
